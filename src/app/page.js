...
export default function Home() {
  return (
      ...
      <div className="flex flex-col justify-center items-center mt-15 gap-5 text-center container mx-auto">
        <h1 className="font-bold text-3xl md:text-5xl text-[#1F2937] ">
        ...
        <button className="btn bg-[#244D3F] text-white hover:bg-[#244D3F99] hover:text-black">
          + Add a Friend
        </button>
